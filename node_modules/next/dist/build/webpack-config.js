...
async function getBaseWebpackConfig(dir, { dev = false, isServer = false, buildId, config, target = 'server', entrypoints }) {
    ...
    let webpackConfig = {
        ...
        plugins: [
            ...
            new webpack_1.default.DefinePlugin(Object.assign({}, config.env ? Object.keys(config.env)
                .reduce((acc, key) => (Object.assign({}, acc, { [`process.env.${key}`]: JSON.stringify(config.env[key]) })), {}) : {}, {
